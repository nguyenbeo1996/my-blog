    ...
    <div className="min-h-screen bg-[#FDFCF7] text-[#2C2C2C] font-sans antialiased">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link href="/about" className="text-sm font-medium text-[#824D3B] hover:text-[#824D3B] transition-colors">About</Link>
            </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-[#E5E3DB] bg-[#FDFCF7]">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="/about" className="block px-3 py-2 text-base font-medium text-[#824D3B] hover:bg-[#F3EFDF] rounded-md">About</Link>
            </div>
          </div>
        )}
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="flex flex-col md:flex-row items-start gap-12 mb-16">
          ...
          {/* Avatar frame matching homepage */}
          ...
          <div className="flex-1">
            <h1 className="font-serif text-4xl font-bold tracking-tight mb-4 text-[#2C2C2C]">
              About Me
            </h1>
