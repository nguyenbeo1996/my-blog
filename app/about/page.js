...
export default function About() {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/duc-khanh-nguyen-do-93757a17b/",
      icon: (
    ...
    {
      name: "GitHub",
      href: "https://github.com/nguyenbeo1996",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/duckhanhnguyen.do/",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/caubebandao/",
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      href: "https://mail.google.com/mail/?view=cm&fs=1&to=nguyen.ddkhanh@gmail.com",
      icon: (
